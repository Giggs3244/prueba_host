provider "aws" {
  ...
  # Otra forma es indicar directamente aqui las credenciales, o mediante la definicion de variables en 'main.tf'
  ...
  /*
  # Otra forma es tenerlas definidas como variables de entorno en el Sistema operativo, por ejemplo
  # shell:
